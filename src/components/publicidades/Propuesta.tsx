...
export default function AdSquare() {
  return (
    <div className="bg-gradient-to-tr from-orange-400 to-orange-600 text-white rounded-lg py-4 px-6 md:p-6 flex flex-col md:flex-row items-center shadow-lg h-full mx-8 text-center md:text-start">
